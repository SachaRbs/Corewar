...
#    Updated: 2019/09/25 15:19:39 by crfernan         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

include ./libft/dependancies_libft.mk
include ./corewar/dependancies_corewar.mk
...
simulink:
	$(MAKE) simulink -C $(L_COREWAR_DIR) --no-print-directory
	$(MAKE) simulink -C $(L_ASSEMBLER_DIR) --no-print-directory
